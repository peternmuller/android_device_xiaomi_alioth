...
public class HighTouchPollingService extends Service {
    ...
    public void onCreate() {
        ...
        getContentResolver().registerContentObserver(Settings.Secure.getUriFor(SETTING_KEY), false, mSettingObserver);
    ...
    public static void startService(Context context) {
        context.startServiceAsUser(new Intent(context, HighTouchPollingService.class), UserHandle.CURRENT);
    }
    ...
    private void writeCurrentValue(boolean readSetting) {
        ...
        dlog("writeCurrentValue: mEnabled=" + mEnabled + " mScreenOn=" + mScreenOn + " isPowerSave=" + isPowerSave);
